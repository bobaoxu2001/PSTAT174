...
## 2. Choose a dataset that you will be interested to analyze for your class final project.
...
```{r}
ts_data <- ts(c(3.53,1.33,1.85,0.61,0.98,3.61,3.44,3.38,2.91,2.12,4.62,2.93),frequency = 4, start = 2018)
plot(ts_data)
```
```{r}
library(forecast) 
